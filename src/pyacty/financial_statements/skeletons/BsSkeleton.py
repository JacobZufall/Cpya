...
#                         c_assets_bal += TrueBalance(attributes).true_balance
#
#                     else:
#                         nc_assets_bal += TrueBalance(attributes).true_balance
#
...
#                 for account, attributes in accounts.items():
#                     if attributes["term"] == "current":
#                         c_liabilities_bal += TrueBalance(attributes).true_balance
#
#                     else:
#                         nc_liabilities_bal += TrueBalance(attributes).true_balance
#
#             else:
#                 for account, attributes in accounts.items():
#                     equities_bal += TrueBalance(attributes).true_balance
#
